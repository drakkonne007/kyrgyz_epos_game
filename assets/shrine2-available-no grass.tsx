...
<tileset version="1.10" tiledversion="1.10.2" name="shrine2-available-no grass" tilewidth="32" tileheight="32" tilecount="84" columns="28">
 <image source="tiles/map/grassLand/Props/shrine2-available-no grass.png" width="896" height="99"/>
 <tile id="0">
  <animation>
