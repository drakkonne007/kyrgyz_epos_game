...
<tileset version="1.10" tiledversion="1.10.2" name="animated grass-3" tilewidth="16" tileheight="16" tilecount="32" columns="16">
 <image source="tiles/map/grassLand/Props/animated grass-3.png" width="256" height="32"/>
 <tile id="0">
  <animation>
