...
{
  VerticalWoodChest({this.nedeedKilledBosses, this.neededItems, required this.myItems, this.isOpened = false,
        ...
        onTick: (){
          for (final myItem in myItems) {
            if(isFlippedHorizontally){
              gameRef.gameMap.container.add(LootOnMap(myItem, position: position + Vector2(15,0)));
            }else{
              gameRef.gameMap.container.add(LootOnMap(myItem, position: position - Vector2(15,0)));
            }
