...
class CampPortalDown extends SpriteAnimationComponent with HasGameRef<KyrgyzGame>
{
  ...
  @override onLoad() async
  {
    ...
    Ground ground = Ground(points, collisionType: DCollisionType.active,isSolid:true,isLoop:true,game:gameRef,isStatic:false);
    add(ground);
    ground = Ground(points2, collisionType: DCollisionType.active,isSolid:true,isLoop:true,game:gameRef,isStatic:false);
    add(ground);
  }
